...
/** Shared content for the class charter, used by both the public
 *  route and the in-app (student) route so the two stay identical. */
export async function CharterView() {
